...
@mcp.tool(
    ...
    description=(
        ...
        "or other regular MCP contexts use semantic_search or "
        "search_items instead, which return richer markdown. "
        ...
        "update_semantic_index first if empty. "
...
@mcp.tool(
    ...
    description=(
        ...
        "the MCP-over-web spec (see platform.openai.com/docs/mcp); "
        "do not rename. Not intended for general MCP clients — in Claude "
        "or other regular MCP contexts use get_item_fulltext and "
        "get_item_metadata, which return richer markdown. "
        ...
        "get_item_fulltext; if none can be extracted, falls back "
