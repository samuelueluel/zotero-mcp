...
- **search_items**: Search your library by title, creator, or content
- **get_item_metadata**: Get detailed information about a specific item, including complete raw metadata via `format="json"`
- **get_item_fulltext**: Get the full text content of an item
- **list_collections**: List all collections in your library
- **list_collection_items**: Get all items in a specific collection
- **list_item_children**: Get child items (attachments, notes) for a specific item
- **list_tags**: Get all tags used in your library
- **list_recent_items**: Get recently added items to your library
